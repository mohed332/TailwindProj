const Navbar = () => {
  return (
      ...
      <ul className=" text-white flex w-[100%] justify-center m-auto items-center gap-5 bg-purple-950 list-none rounded overflow-hidden fixed left-2/4 -translate-x-1/2 font-bold text-2xl">
